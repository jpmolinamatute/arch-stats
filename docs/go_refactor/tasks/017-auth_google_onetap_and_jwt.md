...
- [x] `backend/internal/auth/google.go` provides:
...
- [x] `backend/internal/auth/jwt.go` provides:
...
- [x] `backend/internal/auth/session.go` provides:
...
- [x] `backend/internal/auth/service.go` provides a `Service` orchestrating the full flow:
...
- [x] **Step 2: Write failing tests for JWT**
...
- [x] **Step 3: Write failing tests for session tokens**
...
- [x] **Step 5: Implement auth packages**
