...
<template>
    ...
    <main class="flex-1 flex flex-col items-center justify-center p-6 text-center gap-4">
        ...
        <template v-if="!isAuthenticated">
            <h2 class="text-2xl font-bold">Track Every Arrow</h2>
        ...
        <template v-else>
            <h2 class="text-2xl font-bold">Session Management</h2>
            <p class="max-w-md text-slate-400 text-sm">Create or manage your shooting sessions</p>
            <SessionManager />
        </template>
    </main>
</template>
