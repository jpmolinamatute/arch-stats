...
def create_file_handler(formatter: Formatter, log_level: LogLevel) -> Handler:
...
def create_stream_handler(formatter: Formatter, log_level: LogLevel) -> Handler:
...
def get_logger(file_name: str, log_level: LogLevel) -> logging.Logger:
